const About = () => {
  ...
  return (
    <section id="about" className="py-12 sm:py-16 bg-white dark:bg-neutral-900">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row items-center lg:items-start">
          <div className="lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-brand-pink-500 dark:text-white mb-4">
              Nuestra Historia
            </h2>
            <p className="text-neutral-800 dark:text-gray-200 mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            <p className="text-neutral-800 dark:text-gray-200 text-sm sm:text-base">
          ...
          <div className="lg:w-1/2 lg:pl-8">
            <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-brand-pink-500 dark:text-white">
              Nuestros Valores
            </h3>
            <ul className="space-y-3">
              {values.map((value, index) => (
                <li key={index} className="flex items-start">
                  <i className="fas fa-check-circle mt-1 mr-3 text-brand-pink-500 dark:text-brand-pink-300"></i>
